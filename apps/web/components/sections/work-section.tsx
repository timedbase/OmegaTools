    ...
    >
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          ...
          <p className="font-mono text-[10px] text-foreground/60 md:text-base">/ Secure your assets</p>
        </div>
...
function ProjectCard({
  ...
  return (
    <button
      ...
      className={`group w-full border-b border-foreground/10 py-3 text-left transition-all duration-700 hover:border-foreground/20 md:py-8 ${getRevealClass()}`}
      style={{
