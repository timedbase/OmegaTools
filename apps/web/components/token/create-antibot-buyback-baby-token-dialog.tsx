...
export function CreateAntiBotBuybackBabyTokenDialog({ isOpen, onClose }: CreateAntiBotBuybackBabyTokenDialogProps) {
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Create AntiBot Buyback Baby Token" maxWidth="lg">
      <div className="space-y-6">
        {successData ? (
          <div className="rounded-lg border border-green-500/30 bg-green-500/10 p-6">
            <p className="mb-4 font-mono text-lg font-bold text-green-400">AntiBot Buyback Baby Token Created!</p>
          ...
          <>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="My Protected Buyback Token"
              ...
              <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
                <p className="font-mono text-xs text-blue-400">
                  Creation Fee: 10 MONAD • Combines buyback/rewards with bot protection
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                {isCreating ? "Creating..." : "Create AntiBot Buyback Baby Token"}
              </MagneticButton>
