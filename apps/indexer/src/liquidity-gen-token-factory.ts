...
import { TokenCreated as TokenCreatedEvent } from "../generated/LiquidityGenTokenFactory/LiquidityGenTokenFactory"
import { Token } from "../generated/schema"
import { getOrCreateUser, updateFactoryStats, updateGlobalStats, updateDailyStats } from "./utils"

export function handleLiquidityGenTokenCreated(event: TokenCreatedEvent): void {
  ...
  // Update stats
  updateFactoryStats(event.address.toHexString(), "liquidityGen", BigInt.fromI32(0), event.block.timestamp)
