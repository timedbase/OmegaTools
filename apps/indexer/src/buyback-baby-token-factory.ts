...
import { TokenCreated as TokenCreatedEvent } from "../generated/BuybackBabyTokenFactory/BuybackBabyTokenFactory"
import { Token } from "../generated/schema"
import { getOrCreateUser, updateFactoryStats, updateGlobalStats, updateDailyStats } from "./utils"

export function handleBuybackBabyTokenCreated(event: TokenCreatedEvent): void {
  ...
  // Update stats
  updateFactoryStats(event.address.toHexString(), "buybackBaby", BigInt.fromI32(0), event.block.timestamp)
